class JobOffersController < ApplicationController
  ...
  def index
    ...
    @job_offers = JobOffer.paginate(page: params[:page], per_page: 4)
  end
  ...
  private
    ...
    def job_offer_params
      params.require(:job_offer).permit(:title, :description, :requirements, :salary, :expiration_date)
    end

    def check_admin
      unless current_candidate&.admin?
